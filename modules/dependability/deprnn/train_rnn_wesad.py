...
def main(model, savefile, cuda):
    ...
    train_loader = torch.utils.data.DataLoader(train_data, batch_size=batch_size, shuffle=shuffle_train, **kwargs)
    val_loader = torch.utils.data.DataLoader(val_data, batch_size=test_batch_size, shuffle=shuffle_test, **kwargs)
    ...
    test_loader = torch.utils.data.DataLoader(test_data, batch_size=test_batch_size, shuffle=shuffle_test, **kwargs)
