...
def main(model, savefile, cuda):
    ...
    test_loader = torch.utils.data.DataLoader(val_data, batch_size=test_batch_size, shuffle=shuffle_test, **kwargs)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', default='models/wesad/esn/', type=str, metavar='SD',
