...
def sample_wesad_data(N, seq_len, device, num_labels=4, train=False,
    ...
    with torch.no_grad():
        if x is None and y is None:
            data_loader = torch.utils.data.DataLoader(data, batch_size=N, shuffle=shuffle)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--hidden-size', default=256, type=int, metavar='HS', help='hidden layer size (default: 64)')
    ...
    parser.add_argument('--model', default='rnn', type=str, metavar='MN',
    ...
    with torch.no_grad():
        ...
        X, y, target_label = sample_wesad_data(N, time_step, device, num_labels=4,
